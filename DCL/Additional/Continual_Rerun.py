...
np.savetxt('/home/kraghavan/Projects/Continual/Incremental_Sine/Result_Reruns/result_DCL_training_constant_training_samp_num_w_current_error'+ str(i)+'.csv',\
Result_array_current)
np.savetxt('/home/kraghavan/Projects/Continual/Incremental_Sine/Result_Reruns/result_DCL_training_constant_training_samp_num_w_PREV_error'+ str(i)+'.csv',\
Result_array_previous)
np.savetxt('/home/kraghavan/Projects/Continual/Incremental_Sine/Result_Reruns/result_DCL_all_error_samp_num_w_error'+ str(i)+'.csv',\
all_errors )