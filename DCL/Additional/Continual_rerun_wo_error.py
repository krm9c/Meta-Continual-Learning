...
for i in range(reruns):
    ...
    for  samp_num in range(total_samples):
        ...
        loss = model.backward(num_epochs = 10, K = 5, batch_size = 8,\
...
np.savetxt('/home/kraghavan/Projects/Continual/Incremental_Sine/Result_Reruns/result_DCL_training_constant_training_samp_num_wo_current_error'+ str(i)+'.csv',\
Result_array_current)
np.savetxt('/home/kraghavan/Projects/Continual/Incremental_Sine/Result_Reruns/result_DCL_training_constant_training_samp_num_wo_PREV_error'+ str(i)+'.csv',\
Result_array_previous)
np.savetxt('/home/kraghavan/Projects/Continual/Incremental_Sine/Result_Reruns/result_DCL_all_error_samp_num_wo_error'+ str(i)+'.csv',\
all_errors )