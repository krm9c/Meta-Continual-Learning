...
plt.savefig("/home/kraghavan/Projects/Continual/DCL/Result_paper/DCL_training_previous_tasks_3.png", dpi = 1200)
plt.figure()
plt.plot(t, CTE[i,:])
plt.xlabel('tasks')
plt.ylabel('Current Task Error')
plt.savefig("/home/kraghavan/Projects/Continual/DCL/Result_paper/DCL_training_current_tasks_3.png", dpi = 1200)
np.savetxt('/home/kraghavan/Projects/Continual/DCL/Result_paper/CME_DCL_3.csv',\
CME, delimiter = ',')
np.savetxt('/home/kraghavan/Projects/Continual/DCL/Result_paper/CTE_DCL_3.csv',\
CTE, delimiter = ',')
np.savetxt('/home/kraghavan/Projects/Continual/DCL/Result_paper/TE_DCL_3.csv',\
TE, delimiter = ',')
