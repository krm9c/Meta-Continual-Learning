...
def dataset_return_exp(task_id, total_samples, flag = 'training'):
    ## The task id starts from zero!! Remember that
...
for i in range(total_runs):
    ...
    N, D_in, H, D_out = 4, 784, 1000, total_samples
    ...
    optimizer_current = torch.optim.Adam( model_k.parameters(), lr=learning_rate)
    # The main working loop
    for  samp_num in range(total_samples):
        for epoch in range(2):
            if samp_num > 0:
                dataset = dataset_return_exp((samp_num+1), total_samples)
                ...
                for sample in dataloaders_experience:
                    ...
                    # MAML update is equivalent to two succesive steps of update 
                    # with the gradient accumalated in pytorch.
        ...
        for epoch in range(num_epochs):
            ...
            dataset = dataset_return((samp_num), total_samples)
...
plt.savefig("/home/kraghavan/Projects/Continual/MAML/Results_paper/MAML_training_previous_tasks_OMNI.png", dpi = 1200)
plt.figure()
plt.plot(t, CTE[i,:])
plt.xlabel('tasks')
plt.ylabel('Current Task Error')
plt.savefig("/home/kraghavan/Projects/Continual/MAML/Results_paper/MAML_training_current_tasks_OMNI.png", dpi = 1200)
np.savetxt('/home/kraghavan/Projects/Continual/MAML/Results_paper/CME_MAML_OMNI.csv',\
CME, delimiter = ',')
np.savetxt('/home/kraghavan/Projects/Continual/MAML/Results_paper/CTE_MAML_OMNI.csv',\
CTE, delimiter = ',')
np.savetxt('/home/kraghavan/Projects/Continual/MAML/Results_paper/TE_MAML_OMNI.csv',\
TE, delimiter = ',')
